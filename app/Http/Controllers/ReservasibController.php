...
class ReservasibController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if (!$reservasi) return redirect()->route('reservasib.index')->with('error_message', 'Data reservasi dengan id = ' . $id . ' tidak ditemukan');
